...
const { facebook, github, instagram, twitter, linkedin, medium } = Config.social
    ...
    <div className={`${style.name} centerAlign`}>
      ...
      <ul className={`box ${style.badge} contactBlock`}>
        ...
        <li className={`${style.contactBlockItem}`}>
          ...
          &nbsp; &nbsp;
          <a href="mailto:abhisheksrivastavabbn@gmail.com" target="_top">
